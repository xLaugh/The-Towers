...
/**
 * Point d'entree public de TheTowers pour les autres plugins.
 *
 * <p>Usage cote plugin tiers (avec un {@code softdepend: [TheTowers]}) :
 * <pre>
 * PlayerStats s = TheTowersAPI.get().getStats(uuid);
 * boolean playing = TheTowersAPI.get().isInGame(player);
 * </pre>
 *
 ...
 */
public final class TheTowersAPI {

    private static TheTowersAPI instance;

    private final Main main;

    private TheTowersAPI(Main main) {
        this.main = main;
    }

    /** Appelee une fois par TheTowers a son demarrage. */
    public static void init(Main main) {
        instance = new TheTowersAPI(main);
    }

    /** Instance de l'API, ou {@code null} si TheTowers n'est pas encore active. */
    public static TheTowersAPI get() {
        return instance;
    }
